...
Declarative VM management on NixOS hosts.

## Config

- Read/write via `getModuleConfig "vm"` (never hardcoded `config.core.…` paths).
...
This pack is owned by the module. Delete `vm/` ⇒ pack gone from assistant discovery.
