# 🚀 NixOS Step Recorder - v2.0.0 Release Notes
...
### 🌟 Key Features (9 Major Components)
...
- ✅ **Remote Control** (start/stop/pause/resume recordings)
...
### Collected Metrics
- ✅ **CPU Usage** - Per-step percentage
- ✅ **Memory (RAM)** - Per-step usage
...
### Features
- ✅ **journalctl Integration** - Extract relevant logs
- ✅ **Time Correlation** - Match logs to session timeframe
- ✅ **Error Detection** - Automatically find errors
- ✅ **JSON Export** - Structured log data
- ✅ **Priority Filtering** - Warning and above
...
### Features
- ✅ **inotify Integration** - Real-time file watching
- ✅ **Git Integration** - Commit tracking
- ✅ **Change Detection** - Create, modify, delete, move
...
- ✅ **Auto-Indexing** - Systemd timer for automatic indexing
- ✅ **Multiple Search Formats** - table, json, simple output
...
### Features
- ✅ **HTML Comparison Report** - Pure Bash generator (no Python!)
- ✅ **Diff Highlighting** - Positive/negative/neutral changes
- ✅ **Regression Detection** - Automatic detection of regressions
- ✅ **Batch Comparison** - Compare multiple sessions against baseline
...
⚠ 2 potential regression(s) detected:
- Increased step count: 10 → 15 (+50%)
- Increased duration: 120s → 180s (+50%)
```
...
├── api/
│   ├── server.nix       # FastAPI server
│   ├── default.nix      # CLI client
...
│   └── default.nix
├── analysis/
│   ├── performance-metrics.nix
│   ├── system-logs.nix
│   ├── file-changes.nix
│   └── default.nix
└── search/
    ├── search.nix       # Search & Tags
    ├── comparison.nix   # Session Comparison
    └── default.nix      # Module wrapper
```
...
- **This Release**: `doc/releases/v2.0.0-release.md`
