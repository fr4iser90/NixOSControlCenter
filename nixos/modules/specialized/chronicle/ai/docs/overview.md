...
Screen/session capture and chronicle tooling.

## Config

- Read/write via `getModuleConfig "chronicle"` (never hardcoded `config.core.…` paths).
...
This pack is owned by the module. Delete `chronicle/` ⇒ pack gone from assistant discovery.
