...
let
  ...
  # Load preset if set
  presetConfig = if (systemConfig.system.packages or {}).preset or null != null then
    import (./presets + "/${(systemConfig.system.packages or {}).preset}.nix")
  else null;
  ...
  # Get packages config
  packagesCfg = systemConfig.system.packages or {};
