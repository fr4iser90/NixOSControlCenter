...
PipeWire/audio stack for the host.

## Config

- Read/write via `getModuleConfig "audio"` (never hardcoded `config.core.…` paths).
...
This pack is owned by the module. Delete `audio/` ⇒ pack gone from assistant discovery.
