...
**Related:** [todo.md](./doc/todo.md) (checkbox backlog), [gui-architecture.md](../doc/gui-architecture.md) (Qt/PySide6), older notes in [ncc-command-architecture.md](../doc/ncc-command-architecture.md) (historical; this file wins on conflicts).
...
| `ssh` | CLI (`client` = manager); `--gui` / `--tui` | unify client + server; Target bar uses `~/.creds` |
