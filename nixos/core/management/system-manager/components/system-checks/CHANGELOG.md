...
### Changed
- **BREAKING**: Moved options from `system.postbuild` to `systemConfig.core.management.system-manager.submodules.system-checks.postbuild`
- **BREAKING**: Changed command registration from `core.management.system-manager.submodules.cli-registry.commands` to `core.management.system-manager.submodules.cli-registry.commands`
